...
import { toCssBackgroundImageUrl } from "@/lib/viagens-hero-images";
...
function ViagensHeroBackground({
  images,
  activeIndex,
}: {
...
export function ViagensHero(): ReactNode {
  ...
  return (
    ...
    >
      <motion.div
        ...
        aria-hidden="true"
      >
        <ViagensHeroBackground images={heroBackgroundImages} activeIndex={activeSlide} />
        <div
