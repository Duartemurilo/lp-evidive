...
const { courses } = freediveConfig;

type FreediveCourseCard = (typeof courses.cards)[number];

type CourseCardProps = {
  course: FreediveCourseCard;
...
function FreediveCoursesHeader({
  headingId,
  className,
  eyebrowClassName,
  titleClassName,
...
function FreediveCoursesMobile({
  nivel1,
  nivel2,
}: {
  nivel1: FreediveCourseCard;
  nivel2: FreediveCourseCard;
}): ReactNode {
  return (
    <div className="px-6 py-20 md:py-28 lg:hidden">
      <div className="mx-auto flex max-w-2xl flex-col gap-10 md:max-w-3xl md:gap-12">
        <FreediveCoursesHeader
          headingId="freedive-cursos-heading"
...
function FreediveCoursesDesktop({
  nivel1,
  nivel2,
}: {
  nivel1: FreediveCourseCard;
...
export function FreediveCourses(): ReactNode {
  ...
  return (
    <section
      id={courses.id}
      aria-labelledby="freedive-cursos-heading"
      className="relative w-full overflow-hidden bg-background"
    >
      <FreediveCoursesMobile nivel1={nivel1} nivel2={nivel2} />
      <FreediveCoursesDesktop nivel1={nivel1} nivel2={nivel2} />
    </section>
  );
}
